...
public class HashCode2016 {
	...
	static public void readInput(String filename, String filepath){
		...
		sim = new Simulation(Integer.parseInt(tokens.nextToken()),Integer.parseInt(tokens.nextToken()),Integer.parseInt(tokens.nextToken()),Integer.parseInt(tokens.nextToken()),Integer.parseInt(tokens.nextToken()));
